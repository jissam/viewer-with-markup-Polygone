 ...
 */
export function TableBody({ labels, classes, rowProps, onRowClick: onRowClickProp, controlledProps, children, validRowClickTagNames = VALID_TAGS_FOR_ROW_ONCLICK }) {
    ...
    if (children) {
        ...
        if (dataLength > 0) {
            for (let rowIdx = 0; rowIdx < dataLength; rowIdx++) {
                // Push to array.
                body.push(React.createElement(TableRow, { key: rowIdx, rowData: data[rowIdx], rowIdx: rowIdx, rowProps: rowProps, classes: { td: classes === null || classes === void 0 ? void 0 : classes.td, tr: classes === null || classes === void 0 ? void 0 : classes.tr }, controlledProps: controlledProps, validRowClickTagNames: validRowClickTagNames, onRowClick: onRowClickProp }));
            }
        }
        else {
 ...
 */
export function TableRow({ rowData, rowIdx, onRowClick: onRowClickProp, classes, controlledProps, rowProps, validRowClickTagNames = VALID_TAGS_FOR_ROW_ONCLICK }) {
