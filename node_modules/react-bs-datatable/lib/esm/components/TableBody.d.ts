 ...
 */
export interface TableBodyProps<TTableRowType extends TableRowType> extends CommonProps {
 ...
 */
export declare function TableBody<TTableRowType extends TableRowType>({ labels, classes, rowProps, onRowClick: onRowClickProp, controlledProps, children, validRowClickTagNames }: TableBodyProps<TTableRowType>): JSX.Element;
/**
 * The props for the `TableRow` component.
 */
export interface TableRowProps<TTableRowType extends TableRowType> extends CommonProps {
    /** The row data. */
 ...
 */
export declare function TableRow<TTableRowType extends TableRowType>({ rowData, rowIdx, onRowClick: onRowClickProp, classes, controlledProps, rowProps, validRowClickTagNames }: TableRowProps<TTableRowType>): JSX.Element;
/**
