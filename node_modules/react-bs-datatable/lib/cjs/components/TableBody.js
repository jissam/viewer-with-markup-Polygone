 ...
 */
function TableBody({ labels, classes, rowProps, onRowClick: onRowClickProp, controlledProps, children, validRowClickTagNames = VALID_TAGS_FOR_ROW_ONCLICK }) {
    ...
    if (children) {
        ...
        if (dataLength > 0) {
            for (let rowIdx = 0; rowIdx < dataLength; rowIdx++) {
                // Push to array.
                body.push(react_1.default.createElement(TableRow, { key: rowIdx, rowData: data[rowIdx], rowIdx: rowIdx, rowProps: rowProps, classes: { td: classes === null || classes === void 0 ? void 0 : classes.td, tr: classes === null || classes === void 0 ? void 0 : classes.tr }, controlledProps: controlledProps, validRowClickTagNames: validRowClickTagNames, onRowClick: onRowClickProp }));
            }
        }
        else {
 ...
 */
function TableRow({ rowData, rowIdx, onRowClick: onRowClickProp, classes, controlledProps, rowProps, validRowClickTagNames = VALID_TAGS_FOR_ROW_ONCLICK }) {
    ...
    function onRowClick(event) {
        if (typeof onRowClickProp === 'function') {
            const isValidTagName = validRowClickTagNames === '*' ||
    ...
    for (let colIdx = 0; colIdx < headersLength; colIdx++) {
        ...
        if (checkbox && checkboxState) {
            ...
            // Render normally.
            if (cell === undefined) {
                value = (0, data_1.extractValueFromObject)(prop, rowData);
            }
            else {
                value = cell(rowData);
            }
