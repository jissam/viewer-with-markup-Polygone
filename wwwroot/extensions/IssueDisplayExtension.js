...
import { IssueDisplayPanel } from './IssueDisplayPanel.js';
import '../img/icons8-issue-58.png';

class IssueDisplayExtension extends BaseExtension {
  ...
  onToolbarCreated() {
    this._showButton = this.createToolbarButton('issues-button', 'img/icons8-issue-58.png', 'Issues Display');
  ...
  showPanel() {
    ...
    if (this._panelContainer) {
      ...
      titleDiv.textContent = 'Display Issues';
      ...
      this._panel = new IssueDisplayPanel(this, 'model-tab-panel', 'Display Issues');
...
Autodesk.Viewing.theExtensionManager.registerExtension('IssueDisplayExtension', IssueDisplayExtension);
